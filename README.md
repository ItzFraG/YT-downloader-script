...
```bash
curl -O [https://raw.githubusercontent.com/ВАШ_НИК_НА_ГИТХАБЕ/ИМЯ_РЕПОЗИТОРИЯ/main/dlyt.sh](https://raw.githubusercontent.com/ВАШ_НИК_НА_ГИТХАБЕ/ИМЯ_РЕПОЗИТОРИЯ/main/dlyt.sh) && bash dlyt.sh
